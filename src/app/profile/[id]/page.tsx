export default function UserProfile({params}: any) {
    return (
        <div className="flex items-center justify-center min-h-screen">
            <div
                className="relative rounded-xl overflow-hidden flex flex-col items-center w-90 shadow-lg bg-white font-Roboto-light"
            >
                ...
                <div className="top-16 z-10 flex items-center flex-col gap-4 px-5 py-5">
                    ...
                    <div className="flex items-center flex-col">
                        <p title="name" className="text-black font-Roboto-md"><span>{params.id}</span></p>
